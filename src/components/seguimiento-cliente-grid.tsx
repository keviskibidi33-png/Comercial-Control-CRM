...
export default function SeguimientoClienteGrid({
  ...
  const COLUMNS: readonly GridColumn[] = [
    ...
    { key: "estado_seguimiento", label: "Estado Seguimiento", width: "w-36 min-w-[144px] max-w-[144px]", type: "catalog", catalogKey: "estados_seguimiento", stickyLeft: "563px" },
    { key: "servicio_solicitado", label: "Servicio\nSolicitado", width: "w-[130px] min-w-[130px] max-w-[130px]", type: "text", stickyLeft: "707px" },
    { key: "razon_social", label: "Empresa", width: "w-[160px] min-w-[160px] max-w-[160px]", type: "text", stickyLeft: "837px", isLastPinned: true },
